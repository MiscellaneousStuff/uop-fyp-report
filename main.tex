...
reduces the amount of training data required for sEMG silent speech classification
...
has a similar word-error rate (WER) to a previous approach, both being around 68\%,
but requires far less training data and inference speed is improved. EMG augmentation
